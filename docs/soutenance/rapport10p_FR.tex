...
\caption{Visualisation de l'exploration par frontières dans RViz (esprit TP, CM8) : les \emph{cellules de
frontière} (limite connu/inconnu) sont colorées \textbf{par cluster} (segmentation en composantes connexes),
la sphère jaune marque la frontière-but de meilleure utilité et la ligne bleue le plan Nav2 associé. On
\emph{voit} le liseré coloré grignoter l'inconnu jusqu'à $>90\,\%$ de couverture (capture : \texttt{rviz\_capture.mp4}).}
