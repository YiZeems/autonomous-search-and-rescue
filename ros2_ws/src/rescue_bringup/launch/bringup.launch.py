...
def generate_launch_description() -> LaunchDescription:
    ...
    # MERGE FIX (from autonomous-search-and-rescue/, 2026-06-09): pass params_file
    # explicitly. navigation_launch.py uses RewrittenYaml(source_file=LaunchConfiguration
    # ('params_file')) which evaluates lazily; when included from an outer launch,
    # params_file resolves to '' before the inner DeclareLaunchArgument default fires,
    # causing `[Errno 2] No such file or directory: ''`. Passing it sidesteps the race.
    # See docs/ERRORS_AND_FIXES.md #27.
